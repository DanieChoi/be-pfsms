...
import com.withtec.pfsms.dto.request.notification.PostRedisMessagePublishRequestDto;
...
public class NotificationController {
   ...
   */
  @GetMapping(value = "/{channelId}/subscribe/{loginId}", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
  public ResponseEntity<SseEmitter> subscribe(
    @PathVariable("channelId") String channelId,
    @PathVariable("loginId") String loginId,
    @RequestHeader(value = "Last-Event-ID", required = false, defaultValue = "") String lastEventId
  ) {
    return ResponseEntity.ok(notificationService.subscribe(channelId, loginId));
  }
